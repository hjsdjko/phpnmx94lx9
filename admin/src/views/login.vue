    ...
    <div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230831/a6216f5e76c141a1857e4d0616f5a515.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
      <el-form :style='{"border":"1px solid #f6f6f6","minHeight":"720px","padding":"220px 20px 20px","boxShadow":"0 6px 20px rgba(0, 0, 0, .2)","margin":"0 auto","borderRadius":"0px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230805/e9bfdb2637d249d5a8be2d0cb11b7c72.png) no-repeat center 40px,#fff","width":"660px","fontSize":"16px","position":"relative","height":"auto"}'>
        ...
        <div :style='{"margin":"20px auto 0","alignItems":"center","flexWrap":"wrap","display":"flex","width":"75%","fontSize":"18px","position":"relative","justifyContent":"flex-start"}'>
          ...
          <el-button :style='{"border":"0px solid rgba(64, 158, 255, 1)","cursor":"pointer","padding":"0 8px","margin":"0 5px 10px","borderColor":"rgba(167,142,68,1)","color":"#333","outline":"none","borderRadius":"0px","background":"#f6f6f6","borderWidth":"0px","width":"auto","fontSize":"inherit","borderStyle":"solid","fontWeight":"500","height":"40px"}' type="primary" @click="register('lvshi')" class="register">注册律师</el-button>
        </div>
      </el-form>
