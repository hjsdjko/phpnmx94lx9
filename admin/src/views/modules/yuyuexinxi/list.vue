				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('yuyuexinxi','取消')" @click="quxiaoyuyueCrossAddOrUpdateHandler(scope.row,'cross','是','','')" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 0 0 4px","fontSize":"inherit","color":"inherit","height":"auto"}'></span>
								取消
							</el-button>
							<el-button class="btn8" v-if="isAuth('yuyuexinxi','交流')" @click="jiaoliuxinxiCrossAddOrUpdateHandler(scope.row,'cross','是','','')" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 0 0 4px","fontSize":"inherit","color":"inherit","height":"auto"}'></span>
								交流
							</el-button>
