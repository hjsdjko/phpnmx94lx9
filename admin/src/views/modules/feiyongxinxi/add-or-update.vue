<template>
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="案件项目" prop="anjianxiangmu">
					<el-input  v-model="ruleForm.anjianxiangmu" placeholder="案件项目" clearable  :readonly="ro.anjianxiangmu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="案件项目" prop="anjianxiangmu">
					<el-input v-model="ruleForm.anjianxiangmu" placeholder="案件项目" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="服务类别" prop="fuwuleibie">
					<el-input  v-model="ruleForm.fuwuleibie" placeholder="服务类别" clearable  :readonly="ro.fuwuleibie"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="服务类别" prop="fuwuleibie">
					<el-input v-model="ruleForm.fuwuleibie" placeholder="服务类别" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="费用" prop="feiyong">
					<el-input type="number" v-model.number="ruleForm.feiyong" placeholder="费用" clearable  :readonly="ro.feiyong"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="费用" prop="feiyong">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="服务内容" prop="fuwuneirong">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.fuwuneirong" label="服务内容" prop="fuwuneirong">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.fuwuneirong"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.fuwuneirong = this.ruleForm.fuwuneirong.replace(reg,'../../../phpnmx94lx9/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
