	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="事务所" prop="shiwusuo">
					<el-input  v-model="ruleForm.shiwusuo" placeholder="事务所" clearable  :readonly="ro.shiwusuo"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="事务所" prop="shiwusuo">
					<el-input v-model="ruleForm.shiwusuo" placeholder="事务所" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="职级" prop="zhiji">
					<el-input  v-model="ruleForm.zhiji" placeholder="职级" clearable  :readonly="ro.zhiji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="职级" prop="zhiji">
					<el-input v-model="ruleForm.zhiji" placeholder="职级" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="取消内容" prop="quxiaoneirong">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.quxiaoneirong" label="取消内容" prop="quxiaoneirong">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.quxiaoneirong"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.quxiaoneirong = this.ruleForm.quxiaoneirong.replace(reg,'../../../phpnmx94lx9/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
